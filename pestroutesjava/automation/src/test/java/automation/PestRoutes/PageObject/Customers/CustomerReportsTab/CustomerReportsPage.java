...
public class CustomerReportsPage extends AppData {
    ...
    public String filterTypes_CR(String key) {
        ...
        filterTypes_CR.put("scheduledBy_CR", "//input[@id='s2id_autogen42']");
        filterTypes_CR.put("completedBy_CR", "//input[@id='s2id_autogen43']");
        filterTypes_CR.put("servicedBy_CR", "//input[@id='s2id_autogen44']");
        ...
        filterTypes_CR.put("servicedType_CR", "//input[@id='s2id_autogen45']");
        ...
        filterTypes_CR.put("statusServiceAppointment_CR", "//input[@id='s2id_autogen47']");
