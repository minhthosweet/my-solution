...
public class BillingByServiceType extends AppData {
    ...
    public void validateFields_BillingServiceReport() {
        String[] fields;
        if (CucumberBaseClass.scenarioName().equals("Multi Group By filter validation in BST")) {
        ...
        try {
            ...
            if (elm.isDisplayed()) {
                ...
                if (CucumberBaseClass.scenarioName().equals("Multi Group By filter validation in PST")) {
                    result("Billed After Service", billingFrequency_BBSTReport, "Billing Frequency Validation", "BBST Report Validation");
                } else {
