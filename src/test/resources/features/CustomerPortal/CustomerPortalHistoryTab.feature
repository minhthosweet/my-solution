...
Feature: Customer Portal - History Tab Displays Accurate Information
  ...
  Rule: User views the History Tab within the Customer Portal and see accurate information
    ...
    @VerifyServiceHistorySectionHasCompletedAppointments
    ...
    @VerifyHistoryTabFirstNameInWelcomeBanner
    ...
    @VerifyHistoryTabBalanceForUnpaidInvoice
    ...
    @VerifyViewDetailsButtonTransitionsToBillingTab
    ...
    @VerifyHistoryTabServicePlanHasCorrectServiceType
