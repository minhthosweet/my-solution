...
@CucumberOptions(features = { "src/test/resources/features" }, plugin = {"json:target/cucumber.json", "html:target/site/cucumber-pretty", "pretty"}, glue = {
        "automation.PestRoutes"},tags="@CustomAppointmentDate or @Equipment or @Transfer or @VerifyAppointmentInfoOnAppointmentsTab or @Renewal")
public class CustomerCard extends AbstractTestNGCucumberTests {
    @Override
    @DataProvider
